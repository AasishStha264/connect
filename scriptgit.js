...
async function loadOverlayLayers() {
    ...
    try {
        const localResponse = await fetch('https://backend-yytm.onrender.com/api/local');
        ...
        const districtResponse = await fetch('https://backend-yytm.onrender.com/api/district');
        ...
        const provinceResponse = await fetch('https://backend-yytm.onrender.com/api/province');
...
function clearUploadedShapefiles() {
    ...
    shapefileAName = null; shapefileBName = nu  ll;
    clearSelection();
}
...
async function loadRoadBufferData() {
    try {
        ...
        const roadResponse = await fetch('https://backend-yytm.onrender.com/api/roads');
        ...
        const houseResponse = await fetch('https://backend-yytm.onrender.com/api/buildings');
        ...
        const hospitalResponse = await fetch('https://backend-yytm.onrender.com/api/hospitaa');
